...
const DetailProduct = ({ objectProduct }) => {
  const { addCartProducts } = useContext(CartDetailsContext);
    ...
    <>
      <section className="container mx-auto px-4 md:px-0">
        ...
        <div className="grid grid-cols-3 gap-4 font-bold md:grid-cols-[1fr_1.7fr]">
          <div className="col-span-3 flex items-baseline justify-between rounded-md bg-gray-200 px-5 py-2 pb-3 md:col-span-1">
            <button
